...
function Contact() {
  return (
    <>
    <div className=" p-12">
      <div className="flex justify-center text-[40px] text-[#484747]">Contact Us</div>
      <div className="w-full">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3719.7359503292087!2d72.78446697450318!3d21.20264588049055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be04d6cf4cede03%3A0xe8d226328cae6baf!2sAadinath%20Arcade!5e0!3m2!1sen!2sin!4v1726202963308!5m2!1sen!2sin" width="100%" height="400" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>

    <div className="text-[30px] flex justify-center mt-4">Send Message in Email</div>
        <form className="max-w-sm mx-auto mb-16" method="POST" >
