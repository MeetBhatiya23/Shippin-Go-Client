    ...
    <>
      ...
      <div className="container">
        ...
        <div className="flex justify-evenly  items-center ">
          <div className="flex flex-col mr-[120px] items-center">
            <TbReplace className="payment text-5xl font-normal cursor-pointer text-[#3671f1]" />
            <div className="mt-3 text-[#4f5051]">7 days Replace</div>
          </div>
          <div className="flex flex-col items-center">
            <GiDiamondTrophy className="payment text-5xl font-normal cursor-pointer text-[#3671f1]" />
            <div className="mt-3 text-[#4f5051]">Top Quality</div>
          </div>
        </div>
      </div>
      {/* <hr className="mt-6" /> */}
        ...
        <div className="bg-[#bfd3f570] pt-[4px] mt-9 rounded-[20px] mx-[60px]">
          ...
          <div className="flex justify-center mt-6 pb-7">
            <div className="flex ">
              ...
              <div className="ml-5 items-center mr-4 text-[#504f4f]">
                {" "}
                Digitly
              </div>
            </div>
