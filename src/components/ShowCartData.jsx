...
function ShowCartData(selectedData) {
    const { modelName, images, prices, offers, colours, max, id, amount,size } = selectedData
        ...
        <>
            <div className="grid grid-cols-7 mt-5 pb-5  border-b  border-gray-300">
                ...
                <div className="col-span-2 flex flex-col gap-2">
                    <div className="text-xl">{modelName} -{colours}</div>
                    <div className="text-green-600 text-sm">In stock</div>
                    <div className="text-sm">Eligible for Free Shipping</div>
                    <div className="text-sm"><b>Colour</b> : {colours}</div>
                    <div className="text-sm"><b>Size</b> : {size}</div>
                </div>
                ...
                <div className="flex justify-around items-center">
                    <button>
                        <RiDeleteBin6Fill onClick={() => removeItem(id)} className="text-red-600 text-xl" />
                    </button>
                </div>
            </div><hr />
        </>
